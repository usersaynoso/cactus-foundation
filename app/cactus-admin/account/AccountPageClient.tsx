...
export default function AccountPageClient({ extensionSections }: { extensionSections?: React.ReactNode }) {
  ...
  return (
    <div className="account-grid-container">
      ...
      {/* Module-contributed sections (admins.account-section extension point) */}
      {extensionSections}
