      ...
      MenuBlock: {
        ...
        render: wrapResponsiveRender((props: any) => (
          <MenuBlockEditorPreview
            ...
            activeFontWeight={props.activeFontWeight}
            activeUnderline={props.activeUnderline}
            activeUnderlineColor={props.activeUnderlineColor}
            activeUnderlineThickness={props.activeUnderlineThickness}
            activeUnderlineOffset={props.activeUnderlineOffset}
