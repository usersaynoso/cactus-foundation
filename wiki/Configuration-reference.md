...
| `CLOUDFLARE_WORKER_URL` | No | Your Cloudflare Worker's URL. Required for all proxied media providers (B2, R2, S3, Spaces, Wasabi, MinIO, Vercel Blob, Supabase). Set automatically by the admin **Deploy media Worker** flow. |
