...
- **One delivery time per service.** If a service takes longer for some groups than others, the slowest is sent - never the quickest - and the screen names the groups that are being quoted more slowly than they really are. Promising a date you cannot keep is the expensive kind of wrong.
