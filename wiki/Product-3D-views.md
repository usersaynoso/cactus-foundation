...
2. **A colour option per part.** Your product's variations supply the choices - a **Seat Colour** option and a **Top Finish** option, each with its swatches. In the configurator you simply point each material part at the option that changes it.
...
Because both measurements can be typed in, the configurator also works on a site with no product attributes set up at all: choose **Manual** in both boxes, type the two sizes, and you are done.
