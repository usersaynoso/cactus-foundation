...
So write the answer as you want it to read on the page, not as a private note. If a question turns out to be a one-off - a delivery date, somebody's own office - answer it, then take it off the page afterwards on the product's own **FAQs** tab, where it now sits like any question you wrote yourself.

The buttons beside each one: **Bin it** for the spam and the things that belong in an order enquiry, **Put back in the queue** to undo that, and **Delete** to remove the question and the email address with it for good - which is the one to use if somebody asks you to forget them. Deleting does not take back an answer already on a product page; that comes off on the product's FAQs tab.
