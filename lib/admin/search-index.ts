...
export const ADMIN_SEARCH_ENTRIES: AdminSearchEntry[] = [
  ...
  { id: 'speed-image-resizing', label: 'Send pictures at the size they are shown', section: S.speed, path: '/config?tab=speed#speed-image-resizing', requires: '/config', keywords: ['image', 'images', 'pictures', 'resize', 'resizing', 'cloudflare', 'transformations', 'srcset', 'responsive images', 'avif', 'webp', 'speed', 'slow images', 'large images'] },
