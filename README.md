...
- [Google AI Studio](https://github.com/cactus-foundation-modules/google-ai-studio) - one Google AI Studio key, and the site can make pictures for you. With the Shop module installed, a product's Images tab grows an AI photo section: tick the photographs you already have - the product's own, its variations', any picture attributes on it - say what you would like, and pick from what comes back. With the 3D Views module installed you can add angles captured off the product's own 3D model too. Nothing reaches your media library until you choose it, and nothing reaches the product until you save it.
