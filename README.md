...
- [Google Reviews for Shop](https://github.com/cactus-foundation-modules/google-reviews-for-shop) - finds your products on Google Shopping and brings the reviews people have already written about them into your own Reviews list, on demand or overnight. Every one is labelled so nobody mistakes a stranger's words for a customer's, and it comes with a small renderer you run yourself, so there is no search service to pay for. Requires the Shop and Reviews modules.
