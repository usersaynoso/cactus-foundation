...
- [UK Bookkeeping](https://github.com/cactus-foundation-modules/uk-bookkeeping) - keep the books on your own site and file your VAT return straight to HMRC. Records income and expenses with the receipts attached, works out all nine VAT boxes from those records - you never type one - and locks everything behind a return once it has been filed. Corrections go on the next one, exactly as HMRC expect. Works perfectly well without an HMRC connection if you file some other way.
