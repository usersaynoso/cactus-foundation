...
- [Abandoned Carts for Shop](https://github.com/cactus-foundation-modules/abandoned-carts-for-shop) - shows you the baskets nobody finished, with whatever the shopper had typed into the checkout before they went: name, email, phone, delivery address, discount code. Optional reminder emails, worded in your own email settings, go to the ones who left an address. Records nothing until a shopper agrees to it on your cookie banner, deletes everything after a number of days you choose, and asks nothing of the Shop module itself. Requires the Shop module.
