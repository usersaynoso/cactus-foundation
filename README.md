...
- [UK Bookkeeping](https://github.com/cactus-foundation-modules/uk-bookkeeping) - keep the books on your own site and file your VAT return straight to HMRC. Records income and expenses with the receipts attached, works out all nine VAT boxes from those records - you never type one - and locks everything behind a return once it has been filed. Reads a bank statement, as a PDF or a CSV, and ties it back to what you have already recorded so you can see whether the bank and the books agree. Keeps journals for the things that are not money moving, and a director's loan account for money you put in and take out. Corrections go on the next return, exactly as HMRC expect. Works perfectly well without an HMRC connection if you file some other way.
